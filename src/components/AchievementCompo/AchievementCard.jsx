...
const AchievementCard = (props) => {
  return (
    <div className="card flex flex-col justify-between gap-3 bg-gray-700 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer w-1/3 hover:scale-99 ease">
        <div className='flex items-center justify-between'>
            <img src={props.img} alt={props.title} className='h-10 w-10 object-contain'/>
            <Trophy color="#f0d10a" size={30} />
        </div>
