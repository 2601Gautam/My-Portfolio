...
const Achievements = (props) => {
  ...
  return (
     <ScrollAnimation animateIn="fadeIn">
    <div ref={ref} className='w-full px-20 min-h-screen py-20 flex flex-col gap-10 bg-gray-50' id='Achievements'>
      <div className='flex flex-col gap-3'>
        <h1 className='text-5xl text-start relative left-5 font-bold text-gray-900' style={{fontFamily: '"Poppins", sans-serif'}}>Achievements</h1>
        <p className='text-lg text-start relative left-5 text-gray-700 max-w-2xl' style={{fontFamily: 'Arial, sans-serif'}}>
          Recognitions and milestones from my coding journey and professional development.
        </p>
      </div>
