...
const ProjectSlideDemo = (props) => {
  ...
  return (
    <div className="content lg:w-2/5 w-full p-8 bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center" > 
              <div className='flex flex-col items-center justify-center h-full gap-5 w-full'>
                <a href={props.demo} target='_blank' rel="noopener noreferrer" className='transform hover:scale-105 transition-transform duration-300'>
                  <img src={props.img} alt="project 1" className='lg:h-40 h-44 object-fill rounded-xl shadow-md'/>
                </a>
                ...
                <div className='flex gap-4 mt-4 w-full px-2 '>
                  ...
                  <a style={{display: props.demo==="null" ? 'none' : 'block'}} href={props.demo} target='_blank' rel="noopener noreferrer" className='flex-1'>
                    <button className='w-full flex gap-2 justify-center items-center bg-blue-600 hover:bg-blue-700 text-white  md:px-5 py-3 rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer'>
