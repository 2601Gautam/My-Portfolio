...
const ContactElement = (props) => {
  ...
  const leftPosition = screenWidth > 768 ? props.index * 60 : props.index * 0;
  return (
    <div className="email flex justify-around items-center gap-3 md:w-[35%] px-6 py-3 rounded-xl bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 cursor-pointer shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 hover:scale-99 border border-gray-600/50 hover:border-blue-500/60 group overflow-hidden hover:translate-x-1" style={{position: 'relative', left: `${leftPosition}px`}}>
          {/* Gradient overlay */}
