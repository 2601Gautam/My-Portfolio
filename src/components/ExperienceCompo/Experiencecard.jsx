...
const Experiencecard = (props) => {
  return (
    <div className="exp-details flex gap-2 items-start w-[90%]  group">
      ...
      <div className="flex-1 bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 group-hover:border-blue-200">
        <div className="flex justify-between items-start mb-3">
          <div className="flex-1">
            <h3 className='md:text-xl text-lg font-bold text-gray-900 mb-1 group-hover:text-blue-600 transition-colors' style={{fontFamily: '"Poppins", sans-serif'}}>
                {props.title}
            </h3>
        ...
        <div className='flex flex-wrap gap-4 mb-4 text-sm text-gray-600' style={{fontFamily: 'Arial, sans-serif'}}>
          <div className='flex items-center gap-1.5'>
            ...
            <span className='text-sm md:text-base'>{props.date}</span>
          </div>
        ...
        <p className='text-gray-700 leading-relaxed text-sm md:text-base' style={{fontFamily: 'Arial, sans-serif'}}>
          {props.desc}
        </p>
      </div>
    </div>
